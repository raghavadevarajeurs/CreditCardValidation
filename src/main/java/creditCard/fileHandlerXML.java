...
public class fileHandlerXML extends fileCategorizer {
        ...
        try {
            ...
            for (int temp = 0; temp < nList.getLength(); temp++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if(super.isDateValid(date)) {
                        inputRow = new creditCardInput(eElement.getElementsByTagName("CardNumber").item(0).getTextContent().trim(),
                                date,
    ...
    public  void writeFile(String fileName, List<creditCardInput> creditCardList) {
        ...
        try {
            ...
            for( creditCardInput inputRow : creditCardList ) {
                ...
                // scs-fix later
                mainRootElement.appendChild(getCompany(doc, inputRow.getCardNumber(),
